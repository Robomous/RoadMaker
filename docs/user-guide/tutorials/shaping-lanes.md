...
Pick the **Lane** tool ([Lane](../reference/lane-profile.md)). It shows the road's
...
([Lane Width](../reference/lane-width.md), <kbd>Shift</kbd>+<kbd>L</kbd>): it shows the
...
lay-by — use **Lane Add** ([Lane Add](../reference/lane-add.md)). Click on the road to drop
...
across junction seams), use **Lane Form** ([Lane Form](../reference/lane-form.md)) instead.
To carve a tapering turn lane on a junction approach, see
[Lane Carve](../reference/lane-carve.md).

## 4. Confirm

Check the [Diagnostics](../reference/diagnostics.md) panel — lane widths and links that
