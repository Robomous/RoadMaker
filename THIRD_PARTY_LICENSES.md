...
| stb (stb_truetype.h, stb_image_write.h) | commit 31c1ad3 (no upstream tagged releases) | MIT OR Unlicense (public domain) | https://github.com/nothings/stb | CPU TrueType rasterisation of editable sign faces (`roadmaker::signs::render_face`) and PNG encoding of those faces for glTF embedding; header-only, implementation macros in one core TU each |
