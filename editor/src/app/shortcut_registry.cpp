...
constexpr std::array kTable{
    ...
    Entry{.id = Id::ToolJunctionSurface,
          ...
          .toolbar_group = "Roads",
          .toolbar_order = 48},
    Entry{.id = Id::ToolManeuver,
          .category = "Tools",
          .description = "Maneuver tool (reshape a junction's turns)",
          .primary = QKeyCombination(Qt::ShiftModifier, Qt::Key_M),
          .note = "plain M is the Move tool; Del removes the focused path point",
          .toolbar_group = "Roads",
          .toolbar_order = 49},
    Entry{.id = Id::ToolSignal,
          .category = "Tools",
          .description = "Signal tool (signalize a junction, place signals)",
          .primary = Qt::Key_G,
