<!--
source: https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.8.1/specification/09_geometries/09_01_introduction.html
spec: ASAM OpenDRIVE
version: 1.8.1
fetched: 2026-07-25
...
[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/geom\_overview.png)
...
[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/adding\_primitives.png)
...
<!-- source: https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.8.1/specification/09_geometries/09_02_road_reference_line.html -->
...
[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/road\_elements.png)
...
<!-- source: https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.8.1/specification/09_geometries/09_03_straight_line.html -->

## 9.3 Straight line

A straight line is the simplest geometry element.

[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/straight\_line.png)
...
<!-- source: https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.8.1/specification/09_geometries/09_04_spiral.html -->

## 9.4 Spiral

A spiral is a clothoid that describes a changing curvature of the road reference line.

[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/spiral.png)
...
<!-- source: https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.8.1/specification/09_geometries/09_05_arc.html -->

## 9.5 Arc

An arc describes a road reference line with constant curvature.

[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/arc.png)
...
<!-- source: https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.8.1/specification/09_geometries/09_06_param_poly3.html -->
...
Parametric cubic curves are more flexible and allow a greater variety of road courses than cubic polynoms.
In comparison to cubic polynoms that are defined in a x/y coordinate system or as local u/v coordinates, the coordinates x and y are interpolated separately by their own splines with respect to a common interpolation parameter p.
...
| `pRange` | [e\_paramPoly3\_pRange](../16_annexes/enumerations/map_uml_enumerations.html#top-EAID_22440E30_85F7_48d1_95DF_89D4972EA8BF) | required |  | Range of parameter p.  - Case arcLength: p in [0, @length of `<geometry>`] - Case normalized: p in [0, 1] (Values of polynom paremeters have no unit) |
...
For reasons of consistency to cubic polynoms, they may be calculated simultaneously to cubic polynoms using local u- and v-coordinates.
...
[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/param\_poly\_1.png)

Figure 29. A parametric cubic curve for interpolation of the u-coordinate

[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/param\_poly\_2.png)

Figure 30. A parametric cubic curve for interpolation of the v-coordinate

[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/param\_poly\_3.png)

Figure 31. A parametric cubic curve


<!-- source: https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.8.1/specification/09_geometries/09_07_poly3.html -->
...
[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/poly3.png)
...
[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/curve\_1.png)
...
[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/curve\_2.png)

Figure 34. Transformation from a u/v to a x/y coordinate system with a=b=0

[Figure: img](https://publications.pages.asam.net/standards/ASAM\_OpenDRIVE/ASAM\_OpenDRIVE\_Specification/v1.8.1/specification/\_images/09\_geometry/curve\_3.png)
